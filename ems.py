...
def delete_all():
    result=messagebox.askyesno('Confirm','Do yo really want to delete all the records?')
    if(result):
...
def delete_employee():
    ...
    if not selected_item:
        ...
        treeview_data()
        clear()
        messagebox.showinfo('Deletion successful','Data is deleted')
...
def update_employee():
    ...
    if not selected_item:
        ...
        treeview_data()
        clear()
        messagebox.showinfo('Updation successful','Data is updated')
...
def add_employee():
    if(idEntry.get()=='' or nameEntry.get()=='' or phoneEntry.get()=='' or salaryEntry.get()==''):
        ...
        treeview_data()
        clear()
        messagebox.showinfo('Insertion Successful','Data is added successfully')
...
logo=CTkImage(Image.open('bg.jpeg'),size=(930,158)) 
